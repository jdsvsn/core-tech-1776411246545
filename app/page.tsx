...
const basePath = '/core-tech-1776411246545';
...
export default function Home() {
  ...
  const products = [{ n: 'Hosting', d: 'Our Hosting services provide fast, secure, and reliable website hosting solutions, ensuring that our clients\' online presence is always available and performing optimally. We offer a range of hosting plans to suit different needs and budgets.', i: 'https://images.pexels.com/photos/17489152/pexels-photo-17489152.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'Web Dev', d: 'Our Web Dev services include custom website design and development, e-commerce solutions, and website maintenance, all designed to help our clients establish a strong online presence and achieve their digital goals. Our team of expert web developers use the latest technologies and trends to create fast, secure, and user-friendly websites.', i: 'https://images.pexels.com/photos/14553720/pexels-photo-14553720.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'App Dev', d: 'Our App Dev services include the design, development, and deployment of custom mobile apps for Android and iOS devices, helping our clients to reach their target audience and provide a seamless user experience. We use the latest technologies and frameworks to create high-quality, scalable, and secure mobile apps.', i: 'https://images.pexels.com/photos/54284/pexels-photo-54284.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Domain', d: 'Our Domain services provide our clients with a one-stop solution for all their domain registration and management needs, including domain registration, transfer, and renewal, as well as domain forwarding and masking. We offer competitive pricing and expert advice to help our clients choose the right domain for their business.', i: 'https://images.pexels.com/photos/4160092/pexels-photo-4160092.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Inquiries', d: 'Our Inquiries service provides our clients with a dedicated point of contact for all their questions, concerns, and feedback, ensuring that they receive prompt and personalized support and guidance throughout their journey with us. Our team of experts is always available to provide tailored advice and solutions to meet our clients\' unique needs.', i: 'https://images.pexels.com/photos/7709227/pexels-photo-7709227.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Core Tech, we specialize in providing cutting-edge technological solutions to businesses and individuals in Kuching. With a team of experts in web and app development, hosting, and domain services, we strive to deliver innovative and effective solutions that meet the unique needs of our clients. Our goal is to empower our clients to succeed in the digital age.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">To become the leading technology solutions provider in Kuching, known for our exceptional service, innovative solutions, and commitment to customer satisfaction.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">To deliver high-quality, customer-centric technology solutions that empower businesses and individuals to achieve their goals and succeed in the digital landscape.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Customer first</h4>
                  <p className="text-sm text-on-surface-variant">Our \'Customer First\' core value means that we prioritize the needs and satisfaction of our clients above all else, providing personalized support and tailored solutions to meet their unique requirements.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Innovation</h4>
                  <p className="text-sm text-on-surface-variant">Our commitment to \'Innovation\' drives us to stay at the forefront of technological advancements, continuously updating our skills and knowledge to provide our clients with the latest and most effective solutions.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              ...
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/6804071/pexels-photo-6804071.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
